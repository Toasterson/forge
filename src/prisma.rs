...
pub static DATAMODEL_STR: &'static str =
    include_str!("/export/home/toast/workspace/illumos/forge/prisma/schema.prisma");
...
pub mod domain {
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_domain { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: domain struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "dnsName")] pub dns_name : String } [$ ($ scalar_field) , +] } } ; }
...
pub mod gate {
    ...
    pub mod r#ref {
        ...
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::Ref(direction)
        }
        pub fn equals(value: String) -> WhereParam {
            WhereParam::Ref(_prisma::read_filters::StringFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(_prisma::read_filters::StringFilter, Ref, {
            fn in_vec(_: Vec<String>) -> InVec;
            fn not_in_vec(_: Vec<String>) -> NotInVec;
            fn lt(_: String) -> Lt;
            fn lte(_: String) -> Lte;
    ...
    pub fn create(
        ...
        (name, version, r#ref, branch, publisher, transforms, _params)
    }
    pub fn create_unchecked(
        name: String,
        version: String,
    ...
    impl SelectParam {
        pub fn to_selection(self) -> ::prisma_client_rust::Selection {
            match self {
                ...
                Self::Ref(data) => data.to_selection(),
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_gate { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: gate struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "name")] pub name : String , # [serde (rename = "version")] pub version : String , # [serde (rename = "ref")] pub r#ref : String , # [serde (rename = "branch")] pub branch : String , # [serde (rename = "transforms")] pub transforms : :: prisma_client_rust :: serde_json :: Value , # [serde (rename = "publisherId")] pub publisher_id : String } [$ ($ scalar_field) , +] } } ; }
    ...
    impl From<UncheckedSetParam> for SetParam {
        fn from(param: UncheckedSetParam) -> Self {
            match param {
                ...
                UncheckedSetParam::Ref(value) => Self::SetRef(value),
    ...
    pub enum OrderByParam {
        ...
        Ref(::prisma_client_rust::Direction),
    ...
    pub enum WhereParam {
        ...
        Ref(_prisma::read_filters::StringFilter),
    ...
    impl ::prisma_client_rust::WhereInput for WhereParam {
        fn serialize(self) -> ::prisma_client_rust::SerializedWhereInput {
            let (name, value) = match self {
                ...
                Self::Ref(value) => (r#ref::NAME, value.into()),
    ...
    impl ::prisma_client_rust::ModelTypes for Types {
        ...
        fn scalar_selections() -> Vec<::prisma_client_rust::Selection> {
            vec![
                ...
                ::prisma_client_rust::sel(r#ref::NAME),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(
                    |(name, version, r#ref, branch, transforms, publisher_id, mut _params)| {
                        _params.extend([
                            name::set(name),
                            version::set(version),
                            r#ref::set(r#ref),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (name, version, r#ref, branch, publisher, transforms, mut _params): (
                String,
                String,
                String,
                String,
...
pub mod component {
    ...
    pub mod packages {
        ...
        pub fn equals(value: Option<::prisma_client_rust::serde_json::Value>) -> WhereParam {
            WhereParam::Packages(_prisma::read_filters::JsonNullableFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
    ...
    pub fn create(
        ...
        (name, version, revision, project_url, gate, recipe, _params)
    }
    pub fn create_unchecked(
        name: String,
        version: String,
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_component { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: component struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "name")] pub name : String , # [serde (rename = "version")] pub version : String , # [serde (rename = "revision")] pub revision : String , # [serde (rename = "anitya_id")] # [serde (default , with = "::prisma_client_rust::serde::double_option")] pub anitya_id : Option < String > , # [serde (rename = "repology_id")] # [serde (default , with = "::prisma_client_rust::serde::double_option")] pub repology_id : Option < String > , # [serde (rename = "project_url")] pub project_url : String , # [serde (rename = "recipe")] pub recipe : :: prisma_client_rust :: serde_json :: Value , # [serde (rename = "patches")] pub patches : Vec < String > , # [serde (rename = "scripts")] pub scripts : Vec < String > , # [serde (rename = "archives")] pub archives : Vec < String > , # [serde (rename = "packages")] # [serde (default , with = "::prisma_client_rust::serde::double_option")] pub packages : Option < :: prisma_client_rust :: serde_json :: Value > , # [serde (rename = "gateId")] pub gate_id : String } [$ ($ scalar_field) , +] } } ; }
    ...
    pub struct Data {
        ...
        pub packages: Option<::prisma_client_rust::serde_json::Value>,
        #[serde(rename = "gateId")]
        pub gate_id: String,
        #[serde(rename = "ComponentChange")]
        pub component_change: Option<Vec<super::component_change::Data>>,
    ...
    pub enum SetParam {
        ...
        SetPackages(Option<::prisma_client_rust::serde_json::Value>),
        SetGateId(String),
        ConnectComponentChange(Vec<super::component_change::UniqueWhereParam>),
        DisconnectComponentChange(Vec<super::component_change::UniqueWhereParam>),
        SetComponentChange(Vec<super::component_change::UniqueWhereParam>),
    ...
    pub enum UncheckedSetParam {
        ...
        Scripts(Vec<String>),
        Archives(Vec<String>),
        Packages(Option<::prisma_client_rust::serde_json::Value>),
        GateId(String),
    }
    impl From<UncheckedSetParam> for SetParam {
        fn from(param: UncheckedSetParam) -> Self {
    ...
    pub enum WhereParam {
        ...
        Packages(_prisma::read_filters::JsonNullableFilter),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(
                    |(name, version, revision, project_url, recipe, gate_id, mut _params)| {
                        _params.extend([
                            name::set(name),
                            version::set(version),
                            revision::set(revision),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (name, version, revision, project_url, gate, recipe, mut _params): (
                String,
                String,
                String,
                String,
...
pub mod component_change {
    ...
    pub mod diff {
        ...
        pub fn equals(value: Option<::prisma_client_rust::serde_json::Value>) -> WhereParam {
            WhereParam::Diff(_prisma::read_filters::JsonNullableFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::JsonNullableFilter,
            Diff,
    ...
    pub mod component_id {
        ...
        pub const NAME: &str = "componentId";
        pub struct Set(pub Option<String>);
        impl From<Set> for SetParam {
            fn from(Set(v): Set) -> Self {
                Self::SetComponentId(v)
            }
        }
        impl From<Set> for UncheckedSetParam {
            fn from(Set(v): Set) -> Self {
        ...
        pub fn equals(value: Option<String>) -> WhereParam {
            WhereParam::ComponentId(_prisma::read_filters::StringNullableFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::StringNullableFilter,
            ComponentId,
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_component_change { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: component_change struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "kind")] pub kind : crate :: prisma :: ComponentChangeKind , # [serde (rename = "diff")] # [serde (default , with = "::prisma_client_rust::serde::double_option")] pub diff : Option < :: prisma_client_rust :: serde_json :: Value > , # [serde (rename = "recipe")] pub recipe : :: prisma_client_rust :: serde_json :: Value , # [serde (rename = "version")] pub version : String , # [serde (rename = "revision")] pub revision : String , # [serde (rename = "patches")] pub patches : Vec < String > , # [serde (rename = "scripts")] pub scripts : Vec < String > , # [serde (rename = "archives")] pub archives : Vec < String > , # [serde (rename = "componentId")] # [serde (default , with = "::prisma_client_rust::serde::double_option")] pub component_id : Option < String > , # [serde (rename = "gateId")] pub gate_id : String , # [serde (rename = "changeRequestId")] pub change_request_id : String } [$ ($ scalar_field) , +] } } ; }
    ...
    pub struct Data {
        ...
        #[serde(rename = "diff")]
        pub diff: Option<::prisma_client_rust::serde_json::Value>,
        #[serde(
            rename = "component",
            default,
    ...
    pub enum SetParam {
        ...
        SetDiff(Option<::prisma_client_rust::serde_json::Value>),
    ...
    pub enum UncheckedSetParam {
        Id(String),
        Kind(super::ComponentChangeKind),
        Diff(Option<::prisma_client_rust::serde_json::Value>),
        Recipe(::prisma_client_rust::serde_json::Value),
        Version(String),
        Revision(String),
        Patches(Vec<String>),
    ...
    impl From<UncheckedSetParam> for SetParam {
        fn from(param: UncheckedSetParam) -> Self {
            match param {
                ...
                UncheckedSetParam::Scripts(value) => Self::SetScripts(value),
                UncheckedSetParam::Archives(value) => Self::SetArchives(value),
                UncheckedSetParam::ComponentId(value) => Self::SetComponentId(value),
                UncheckedSetParam::GateId(value) => Self::SetGateId(value),
    ...
    pub enum WhereParam {
        ...
        Diff(_prisma::read_filters::JsonNullableFilter),
        ComponentIsNull,
        ...
        ComponentId(_prisma::read_filters::StringNullableFilter),
        GateId(_prisma::read_filters::StringFilter),
    ...
    impl ::prisma_client_rust::WhereInput for WhereParam {
        fn serialize(self) -> ::prisma_client_rust::SerializedWhereInput {
            let (name, value) = match self {
                ...
                Self::ComponentId(value) => (component_id::NAME, value.into()),
                Self::GateId(value) => (gate_id::NAME, value.into()),
    ...
    impl ::prisma_client_rust::ModelTypes for Types {
        ...
        fn scalar_selections() -> Vec<::prisma_client_rust::Selection> {
            vec![
                ...
                ::prisma_client_rust::sel(scripts::NAME),
                ::prisma_client_rust::sel(archives::NAME),
                ::prisma_client_rust::sel(component_id::NAME),
                ::prisma_client_rust::sel(gate_id::NAME),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(
                    |(kind, recipe, version, revision, gate_id, change_request_id, mut _params)| {
                        _params.extend([
                            kind::set(kind),
                            recipe::set(recipe),
                            version::set(version),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (kind, recipe, version, revision, gate, change_request, mut _params): (
                super::ComponentChangeKind,
                ::prisma_client_rust::serde_json::Value,
                String,
                String,
...
pub mod build_job {
    ...
    pub fn create(
        ...
        (component, change_request, _params)
    }
    pub fn create_unchecked(
        component_id: String,
        change_request_id: String,
    ...
    #[macro_export]
    macro_rules ! _include_build_job { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: build_job :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: build_job :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: build_job :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: build_job :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: build_job :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: build_job :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: build_job :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: build_job :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { component , change_request } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub id : String , pub component_id : String , pub change_request_id : String , $ (pub $ field : crate :: prisma :: build_job :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (id) , stringify ! (component_id) , stringify ! (change_request_id)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: build_job :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: build_job :: id :: NAME , & self . id) ? ; state . serialize_field (crate :: prisma :: build_job :: component_id :: NAME , & self . component_id) ? ; state . serialize_field (crate :: prisma :: build_job :: change_request_id :: NAME , & self . change_request_id) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , id , component_id , change_request_id } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: build_job :: $ field :: NAME) , + , crate :: prisma :: build_job :: id :: NAME , crate :: prisma :: build_job :: component_id :: NAME , crate :: prisma :: build_job :: change_request_id :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: build_job :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: build_job :: id :: NAME => Ok (Field :: id) , crate :: prisma :: build_job :: component_id :: NAME => Ok (Field :: component_id) , crate :: prisma :: build_job :: change_request_id :: NAME => Ok (Field :: change_request_id) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut id = None ; let mut component_id = None ; let mut change_request_id = None ; while let Some (key) = map . next_key () ? { match key { Field :: id => { if id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: build_job :: id :: NAME)) ; } id = Some (map . next_value () ?) ; } Field :: component_id => { if component_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: build_job :: component_id :: NAME)) ; } component_id = Some (map . next_value () ?) ; } Field :: change_request_id => { if change_request_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: build_job :: change_request_id :: NAME)) ; } change_request_id = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: build_job :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: build_job :: $ field :: NAME)) ? ;) * let id = id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: build_job :: id :: NAME)) ? ; let component_id = component_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: build_job :: component_id :: NAME)) ? ; let change_request_id = change_request_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: build_job :: change_request_id :: NAME)) ? ; Ok (Data { id , component_id , change_request_id , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["id" , "component" , "change_request" , "componentId" , "changeRequestId"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: build_job :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; component : $ selection_mode : ident { $ ($ selections : tt) + }) => { component :: Data } ; (@ field_type ; component) => { crate :: prisma :: component :: Data } ; (@ field_type ; change_request : $ selection_mode : ident { $ ($ selections : tt) + }) => { change_request :: Data } ; (@ field_type ; change_request) => { crate :: prisma :: change_request :: Data } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "BuildJob" , available relations are "component, change_request")) } ; (@ field_module ; component : $ selection_mode : ident { $ ($ selections : tt) + }) => { crate :: prisma :: component :: include ! (@ definitions ; ; $ ($ selections) +) ; } ; (@ field_module ; change_request : $ selection_mode : ident { $ ($ selections : tt) + }) => { crate :: prisma :: change_request :: include ! (@ definitions ; ; $ ($ selections) +) ; } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; component $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? : $ selection_mode : ident { $ ($ selections : tt) + }) => { { Into :: < crate :: prisma :: build_job :: IncludeParam > :: into (crate :: prisma :: build_job :: component :: Include :: $ selection_mode (crate :: prisma :: component :: select ! (@ selections_to_params ; : $ selection_mode { $ ($ selections) + }) . into_iter () . collect ())) } } ; (@ selection_field_to_selection_param ; component $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ?) => { { Into :: < crate :: prisma :: build_job :: IncludeParam > :: into (crate :: prisma :: build_job :: component :: Include :: Fetch) } } ; (@ selection_field_to_selection_param ; change_request $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? : $ selection_mode : ident { $ ($ selections : tt) + }) => { { Into :: < crate :: prisma :: build_job :: IncludeParam > :: into (crate :: prisma :: build_job :: change_request :: Include :: $ selection_mode (crate :: prisma :: change_request :: select ! (@ selections_to_params ; : $ selection_mode { $ ($ selections) + }) . into_iter () . collect ())) } } ; (@ selection_field_to_selection_param ; change_request $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ?) => { { Into :: < crate :: prisma :: build_job :: IncludeParam > :: into (crate :: prisma :: build_job :: change_request :: Include :: Fetch) } } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: build_job :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; id) => { "id" } ; (@ field_serde_name ; component) => { "component" } ; (@ field_serde_name ; change_request) => { "change_request" } ; (@ field_serde_name ; component_id) => { "componentId" } ; (@ field_serde_name ; change_request_id) => { "changeRequestId" } ; }
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_build_job { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: build_job struct $ struct_name { # [serde (rename = "id")] pub id : String , # [serde (rename = "componentId")] pub component_id : String , # [serde (rename = "changeRequestId")] pub change_request_id : String } [$ ($ scalar_field) , +] } } ; }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(self, data: Vec<(String, String, Vec<SetParam>)>) -> CreateMany<'a> {
            let data = data
                .into_iter()
                .map(|(component_id, change_request_id, mut _params)| {
                    _params.extend([
                        component_id::set(component_id),
                        change_request_id::set(change_request_id),
                    ]);
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (component, change_request, mut _params): (
                super::component::UniqueWhereParam,
                super::change_request::UniqueWhereParam,
                Vec<SetParam>,
            ),
