...
pub mod component_change {
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (kind, diff, recipe, version, revision, gate, change_request, mut _params): (
                super::ComponentChangeKind,
                ::prisma_client_rust::serde_json::Value,
                ::prisma_client_rust::serde_json::Value,
                String,
